 ...
 * file, You can obtain one at http://mozilla.org/MPL/2.0/. */
 ...
 //   * `grant_type=fxa-assertion` for directly granting via an FxA identity assertion
 //
...
const GRANT_FXA_ASSERTION = 'fxa-assertion';
...
const PAYLOAD_SCHEMA = Joi.object({
  ...
  // in the refresh and fxa-assertion flows it's optional because of public clients.
